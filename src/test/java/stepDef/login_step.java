...
public class login_step extends config {
    ...
    public void studentEnterTheirInvalidPassword() {
        driver.findElement(By.name("password")).sendKeys("fakePassword$123232");
    }
    ...
    public void studentShouldGetAnErrorMessageForEnteringInvalidPassword() {
        driver.findElement(By.name("email")).sendKeys("fakeemail999999@gmail.com");
    }

    @And("student enter their invalid email address")
    public void studentEnterTheirInvalidEmailAddress() throws InterruptedException {
